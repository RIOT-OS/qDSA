...
extern void fe1271_mulconst(fe1271 *r, const fe1271 *x, const unsigned char b[2]);
...
extern void bigint_sqr(unsigned char *r, const unsigned char *x);
extern void bigint_mul(unsigned char *r, const unsigned char *x, const unsigned char *y);
extern void bigint_red(unsigned char *r, const unsigned char *x);
